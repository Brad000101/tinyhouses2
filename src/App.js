...
const styles = {
  ...
  // Simple loading/error states if needed (though less critical here)
  loading: {
    textAlign: 'center', padding: '3rem', fontSize: '1.2rem', color: '#555',
  },
  error: {
      textAlign: 'center', padding: '2rem', backgroundColor: '#f8d7da', color: '#721c24', border: '1px solid #f5c6cb', borderRadius: '4px',
  }
};
...
const containerHomeModels = [
    {
        ...
        image: 'https://via.placeholder.com/600x400/3498db/FFFFFF?text=The+Solo+Model',
    },
    {
        id: 'model-duo',
        name: 'The Duo',
        ...
        image: 'https://via.placeholder.com/600x400/2ecc71/FFFFFF?text=The+Duo+Model',
    },
    {
        id: 'model-family',
        name: 'The Family Hub',
        ...
        image: 'https://via.placeholder.com/600x400/e74c3c/FFFFFF?text=Family+Hub+Model',
    },
    {
        id: 'model-office',
        name: 'The Workspace',
        ...
        image: 'https://via.placeholder.com/600x400/f1c40f/FFFFFF?text=Workspace+Model',
    },
];

// --- WhatsApp Configuration ---
const WHATSAPP_NUMBER = '+15551234567'; // !! REPLACE WITH YOUR ACTUAL WHATSAPP NUMBER (including country code)
    ...
    return (
        ...
        >
            <img
                ...
                onError={(e) => e.target.src = 'https://via.placeholder.com/600x400/cccccc/FFFFFF?text=Image+Error'}
            />
    ...
    return (
        <div style={styles.container}>
            ...
            <header style={styles.header}>
                <h1 style={styles.headerTitle}>Container Homes Inc.</h1>
